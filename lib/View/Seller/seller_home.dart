...
class _SellerHomeState extends State<SellerHome> {
  ...
  void initState() {
    ...
    super.initState();
    getData();
    HomeController.i.getCategories(context: context,loading: false);
            ...
            child:GetBuilder<HomeController>(
                ...
                return Column(
                  ...
                  children: [
                    ...
                    ViewAll(title:"My Products",onTap: (){
                      AppNavigation.navigateTo(context, AppRouteName.ADD_PRODUCT_ROUTE);
                    },trailing: Row(children: [Icon(Icons.add_box_rounded,color: MyColors().purpleColor,),SizedBox(width: 2.w,), MyText(title: 'Add Product',under: true,fontWeight: FontWeight.w600,)],),),
    ...
    return Expanded(
      ...
      GridView.builder(
          ...
          itemBuilder: (context,index){
            return ProductTile(p:p[index],index: index,showFavorite: false);
          }),
    );
  }

  Future<void> getData({loading}) async{
    await HomeController.i.getAllProducts(context: context,loading: loading,myProducts: true);
  }
}
