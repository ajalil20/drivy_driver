...
//       }
//       // BlocProvider.of<AuthenticationCubit>(MyApp.globalkey.currentState!.context)
...
//     if (payload != null) {
//       Utils().goToNotificationRoute(context: globalkey.currentContext!, n: NotificationModel.fromJson(jsonDecode(payload)),isPush: true);
//     }
//   }
...
//       onNotificationReceived(c:globalkey.currentState!.context,n:NotificationModel.fromJson(message.data));
//     });
//   }
...
//       Utils().goToNotificationRoute(context: globalkey.currentState,n: NotificationModel.fromJson(terminatedMessage!.data),isPush: true);
//     });
//   }
...
//     log("objectsss eeees");
//     if(msg!=null){
//       Utils().goToNotificationRoute(context: globalkey.currentState!.context,n: NotificationModel.fromJson(msg.data),isPush: true);
//     }
//     else{
...
//     if(n.notificationType==AppStrings.STREAM_REQUEST_NOTIFICATION || n.notificationType==AppStrings.STREAM_REQUEST_CANCELLED_NOTIFICATION){
//       HomeController.i.getStreaming(loading:false,context: c);
//     } else if(n.notificationType==AppStrings.ORDER_STATUS_NOTIFICATION){
//       HomeController.i.recentOrderStatusUpdate(o: OrderModel(id: n.orderId),status: n.orderStatus);
//     } else if(n.notificationType==AppStrings.NEW_ORDER_NOTIFICATION){
//       HomeController.i.getOrderHistory(loading: false,context: c,recent: true);
//     } else if(n.notificationType==AppStrings.STREAM_NOTIFICATION){
//       HomeController.i.getStreaming(loading:false,context: c);
//     }
//   }
