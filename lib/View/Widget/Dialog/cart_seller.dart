            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 2.h,),
                  Center(child: MyText(title: 'You still have items from another seller. Start over with a fresh cart?',clr: MyColors().black,size: 13,center: true,)),
                  SizedBox(height: 2.h,),
                  Row(
                    children: [
                      Flexible(
                        child: MyButton(
                          onTap: (){AppNavigation.navigatorPop(c);},
                          title: "Close",bgColor: MyColors().purpleColor,
                        ),
                      ),
                      SizedBox(width: 2.w,),
                      Flexible(
                        child: MyButton(
                            onTap: (){AppNavigation.navigatorPop(c);widget.onYes();},
                            title: "Remove items"
                        ),
                      ),
                    ],
